...
export class DashboardCard {
    ...
    readonly baseClass = 'flex flex-col pl-5 justify-between rounded-lg md:rounded-2xl w-full lg:w-65 grow h-45 px-2 py-4 text-gray-100 font-semibold shadow-xl hover:shadow-white/50 transition-shadow duration-200';
